...
funcion mayor_menor(num1,num2,num3)// ejercicio 4 y ejercicio 5
...
Fin Funcion
funcion notas_promedio(num1,num2)
			...
			"1":
				...
				Mientras opc1<>"21" Hacer
					...
					Segun opc1 Hacer
						...
						"6":
							Escribir "Comprar productos el baraton "
							Escribir "Ingrese la compra"
							Leer ventas
						...
						"8":
							...
							Leer segundot
							notas_promedio(primer,segundot)
							Escribir "Espere por favor, Regresando Al Menu..."
							Esperar 4 Segundos
							Borrar Pantalla
						"9":
